...
public class AnalizadorFrecuencias {
    //Tabla de frecuencias: un contador por cada valor posible de caracter (0 a 255, ASCII extendido)
    //Aqui si podemos indexar directo con el caracter(Java lo convierte a su valor numerico automaticamente), a diferencia de la tabla de codigos de ArbolHuffman, que no podia usar el caracter como indice de esa forma
    private int[] contador;

    //Constructor: arranca la tabla en ceros
    public AnalizadorFrecuencias(){
        //256 cubre el ASCII extendido: letras, numeros, signos y acentos/enie del español (a, e, i, o, u, ni)
        //NOTA: esto es una limitacion de alcance a proposito, ya que el proyecto solo cobre texto plano
        contador = new int[256];
    }//Cierra el constructor
    /**
     * Recorre el texto completo y cuenta cuantas veces aparece cada caracter
     * @param texto el texto de entrada (puede venir de un archivo .txt o escrito directo en la interfaz)
     */
    public void contar(String texto){
        //Reiniciamos la tabla en ceros por si este objeto ya se habia usado antes con otro texto
        ...
        for (int i = 0; i < texto.length(); i++){
            ...
            //(int) actual convierte el caracter a su valor numerico, que es el indice en la tabla
    ...
    /**
     * Arma una ColaPrioridad nueva, con una hoja (NodoHuffman) por cada caracter que SI aparecio en el texto. Los caracteres con frecuencia cero no generan nodo, porque no forman parte del texto real
